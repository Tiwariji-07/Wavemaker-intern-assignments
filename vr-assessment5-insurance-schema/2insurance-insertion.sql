...
insert into users(id,user_name,emp_id,email,
	...
	(2,'ajay',11480,'ajay@email.com','1234','hyderabad','2001-05-01','pic/img1.png','b+','12345678890',1,1,1,'no',2),
	(3,'sneha',11950,'sneha@email.com','1234','hyderabad','2001-07-01','pic/img2.png','ab+','8888888999',2,4,2,'yes',2),
	(4,'aakash',11987,'aakash@email.com','1234','hyderabad','2001-10-01','pic/img3.png','o+','123457890',1,3,1,'yes',2),
	(5,'mohd',11985,'mohd@email.com','1234','hyderabad','2003-01-01','pic/img4.png','ab-','1234547890',1,2,2,'no',2),
	(6,'divya',1199,'divya@email.com','1234','hyderabad','2001-01-08','pic/img5.png','o+','1234587890',2,1,1,'yes',1);
-- 


insert into user_cycle (id,user_id ,cycle_id)
	values (1,1,1,1),(2,1,3,0),(3,2,1,1),(4,2,5,1),(5,2,3,0),(6,4,1,1);
-- 
...
-- testing of cycles duplicate year
-- insert into cycles(id,start_year ,end_year ,edit_permission,company_id)
-- 	values(6,2015,2016,'yes',1);
